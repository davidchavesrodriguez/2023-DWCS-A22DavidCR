...
<body>
    ...
    abstract class Vehicle
    {
        ...
        abstract public function imposto();
    }
    ...
    class Truck extends Vehicle
    {
        ...
        {
            return $this->cv / 30 + $this->power * 20 + $this->wheels * 20 + $this->axles * 50;
        }
    }
    ...
    class Motorcycle extends Vehicle
    {
        ...
        public function imposto()
        {
            return $this->cv / 30 + $this->power + 30;
        }
    }
    ...
    echo $truck1->imposto() . "<br>";
    echo $truck2->imposto() . "<br>";
    echo $motorcycle1->imposto() . "<br>";
    echo $motorcycle2->imposto() . "<br>";
